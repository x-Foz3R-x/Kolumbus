...
export default function SidebarMenu({ tripId }: { tripId: string }) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 top-0 z-40">
      <div className="mt-14"></div>
      <div className="shadow-kolumbus flex max-h-full w-56 flex-none select-none flex-col gap-3 overflow-y-scroll">
