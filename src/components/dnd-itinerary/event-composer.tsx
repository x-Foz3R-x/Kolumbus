...
import { Day, FieldsGroup, LANGUAGES } from "@/types";
...
export const EventComposer = memo(function EventComposer({ day, dayIndex, dragging }: EventComposerProps) {
  const { userId, tripId, eventCount, eventLimit, setSaving, createEvent } = useDndItineraryContext();
  ...
  const handleAdd = () => {
    ...
    if (prediction === null) {
      ...
      details.mutate(
        { place_id: prediction.placeId, fields: FieldsGroup.Basic + FieldsGroup.Contact, language: LANGUAGES.English, sessionToken },
        {
          onSuccess(data) {
  ...
  return (
    <Floating
      ...
      customAnimation={{
        ...
        animate: { width: "312px", height: "48px", transition: { ease: EASING.anticipate, duration: 0.6 } },
        exit: { width: "32px", height: "112px", transition: { ease: EASING.anticipate, duration: 0.6 } },
      }}
      trapFocus
      scrollIntoView
      zIndex={30}
    ...
    >
      ...
      >
        <Combobox.Input
          ...
          containerProps={{
            className: "relative z-10 flex h-full items-center rounded-2xl bg-white fill-gray-400 dark:fill-gray-600 text-sm",
            initial: {
              paddingRight: "0px",
        ...
        >
          <Button
            ...
            exit={{ width: "32px", paddingInline: "8px", pointerEvents: "none", transition: { ease: EASING.anticipate, duration: 0.6 } }}
          ...
          <Button
            ...
            animate={{
              ...
              paddingInline: "14px",
              pointerEvents: "auto",
              transition: { ease: EASING.anticipate, duration: 0.3, delay: 0.1, pointerEvents: { delay: 0.6 } },
            }}
            exit={{ width: "0px", paddingInline: "0px", pointerEvents: "none", transition: { ease: EASING.anticipate, duration: 0.3 } }}
