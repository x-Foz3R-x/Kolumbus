...
export type TooltipProps = {
  ...
  flip?: FlipOptions;
  arrow?:
    | { width?: number; height?: number; tipRadius?: number; className?: string; padding?: number }
    | true;
  focus?: UseFocusProps;
...
export function Tooltip({
  ...
  const { delay: groupDelay } = useDelayGroup(data.context, { id: data.context.floatingId });
  ...
  const focus = useFocus(data.context, {
    enabled: controlledOpen == null || focusOptions?.enabled,
    ...focusOptions,
  });
