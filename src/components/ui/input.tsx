...
export default function Input({
  ...
  return (
    <div style={divStyle} className="relative focus-within:z-30">
      {textWidth && (
        <h1 className={cn(InputVariants({ variant, className }), "invisible w-fit whitespace-pre border-r")}>
          {inputValue}
        </h1>
      )}
...
export const BasicInput = forwardRef<HTMLInputElement, InputBasicProps>(
