...
const ModalVariants = cva(
  "mx-3 overflow-hidden antialiased font-normal rounded-xl border bg-white font-inter shadow-floating dark:border-gray-700 dark:bg-gray-800 dark:text-white",
  {
    variants: {
      size: {
        xs: "max-w-xs",
