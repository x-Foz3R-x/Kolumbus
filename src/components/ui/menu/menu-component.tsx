                  ...
                  {isOpen && (
                    <FloatingList elementsRef={elementsRef} labelsRef={labelsRef}>
                      <motion.ul
                        ...
                        className={cn(
                          "flex flex-col overflow-auto rounded-xl bg-white p-1.5 font-inter font-normal antialiased shadow-floating dark:border-gray-700 dark:bg-gray-800 dark:text-white",
                          className,
                        )}
                        initial="initial"
                        animate="animate"
