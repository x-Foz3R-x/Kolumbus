...
const SpinnerVariants = cva("pointer-events-none select-none fill-gray-800", {
  variants: {
    size: {
      xs: "h-4 w-4",
      sm: "h-5 w-5",
...
export const Spinner = {
  ...
  default: ({ size, className }: SpinnerProps) => {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" className={cn(SpinnerVariants({ size, className }))}>
        <path
