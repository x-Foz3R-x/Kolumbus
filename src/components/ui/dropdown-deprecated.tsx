...
const OptionVariants = cva("fill-gray-400 tracking-tight text-gray-900 dark:fill-gray-600 dark:text-white", {
  variants: {
    variant: {
      default: "focus:fill-gray-900 dark:focus:fill-white",
      primary: "focus:fill-kolumblue-100 focus:text-white",
      danger: "fill-red-500 text-red-500 focus:fill-white focus:text-white",
      unset: "",
    },
    size: {
...
export function DropdownOption({ id, index, onClick, variant, size, className, wrapperClassName, children }: DropdownOptionProps) {
