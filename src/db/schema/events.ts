...
export const eventsRelations = relations(events, ({ one }) => ({
  ...
  activity: one(activities, { fields: [events.id], references: [activities.eventId] }),
  transportation: one(transportations, { fields: [events.id], references: [transportations.eventId] }),
