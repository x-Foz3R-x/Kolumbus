...
export default function Logo() {
  ...
  return (
    <Link
      ...
      className="absolute left-8 top-1.5 z-10 flex flex-shrink-0 items-center rounded-3xl border-2 border-double border-kolumblue-500 fill-kolumblue-500 p-0.5 text-2xl font-bold text-kolumblue-500 backdrop-blur-lg backdrop-saturate-[180%] duration-500 ease-kolumb-flow hover:rounded focus:rounded"
    >
