...
import { Divider } from "@/components/divider copy";
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center text-[13px] text-gray-500">
        <Link href="/signin/reset-password" className="text-kolumblue-600 decoration-kolumblue-500 hover:underline focus-visible:underline">
          Forgot password?
        </Link>

        <div>
          <span>Don’t have an account? </span>
          <Link href="/signup" className="text-kolumblue-600 decoration-kolumblue-500 hover:underline focus-visible:underline">
            Create yours now
