...
import type { verifyEmailSchema } from "~/lib/validations/auth";
    ...
    <Form onSubmit={onSubmit}>
      ...
      <div className="space-y-4 px-2 pb-2 *:text-[13px] *:text-gray-500">
        <p>
          ...
          <Link
            href="/terms"
            className="font-medium text-kolumblue-500 underline-offset-1 hover:underline"
          >
            Terms of Service
          </Link>
          {" and "}
          ...
          . These outline our guidelines, protective measures, and your information’s
          confidentiality.
        </p>
      </div>
