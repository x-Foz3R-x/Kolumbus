  ...
  theme: {
    extend: {
      ...
      spacing: {
        "128d": "36vw",
        "120d": "34vw",
        "32d": "clamp(7.2rem,8vw,10rem)",
        "28d": "clamp(6.3rem,7vw,8.75rem)",
        "24d": "clamp(5.4rem,6vw,7.5rem)",
        "20d": "clamp(4.5rem,5vw,6.25rem)",
        "16d": "clamp(3.6rem,4vw,5rem)",
        "14d": "clamp(3.15rem,3.5vw,4.375rem)",
        "12d": "clamp(2.7rem,3vw,3.75rem)",
        "10d": "clamp(2.25rem,2.5vw,3.125rem)",
        "8d": "clamp(1.8rem,2vw,2.5rem)",
        "6d": "clamp(1.35rem,1.5vw,1.875rem)",
        "4d": "clamp(0.9rem,1vw,1.25rem)",
      },
      fontSize: {
