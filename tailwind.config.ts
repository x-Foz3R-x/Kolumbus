...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "scale-2xl": ["min(max(3.5rem, 4vw), 5rem)", "0.8"],
        "scale-xl": ["min(max(2.62rem, 3vw), 3.75rem)", "0.8"],
        "scale-lg": ["min(max(2.15rem, 2.5vw), 3.1rem)", "0.8"],
        "scale-md": ["min(max(1.75rem, 2vw), 2.5rem)", "0.8"],
        "scale-sm": ["min(max(1.4rem, 1.6vw), 2rem)", "0.8"],
        "scale-xs": ["min(max(1.05rem, 1.2vw), 1.5rem)", "0.8"],
        "scale-2xs": ["min(max(0.7rem, 0.8vw), 1rem)", "0.8"],
      },
    },
  },
  plugins: [
